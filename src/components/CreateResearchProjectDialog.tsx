...
import { industries, researchProjectStatus } from "../utils/AutoComplete";
import { projectTypes, scales } from "../utils/DropdownOption";
import { getProjectType, getVietnameseScale } from "../utils/ChangeText";
import type {
  ResearchProject,
            ...
            >
              ...
              <Box>
                <FormControl fullWidth>
                  ...
                  >
                    {researchProjectStatus.map((status) => (
