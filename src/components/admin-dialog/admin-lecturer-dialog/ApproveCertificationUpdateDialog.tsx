...
const ApproveCertificationUpdateDialog: React.FC<
  ApproveCertificationUpdateDialogProps
> = ({ open, onClose, data, onSuccess }) => {
  ...
  const comparisonRows = [
    ...
    { label: "Ngày cấp", originalKey: "issueDate", updateKey: "issueDate" },
    {
      ...
      updateKey: "expiryDate",
    },
    { label: "Trình độ", originalKey: "level", updateKey: "level" },
    {
      label: "URL tài liệu",
      originalKey: "certificateUrl",
      updateKey: "certificateUrl",
    },
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      if (confirmDialog.type === "approve") {
        await API.admin.approveCertificationUpdate({
