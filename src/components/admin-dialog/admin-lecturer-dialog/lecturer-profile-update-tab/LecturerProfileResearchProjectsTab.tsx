...
const LecturerProfileResearchProjectsTab: React.FC<LecturerProfileResearchProjectsTabProps> = ({
    ...
    <Box>
      ...
      >
        <Typography variant="h6">
          Dự án nghiên cứu ({researchProjects.length})
        </Typography>
        <Button
          variant="contained"
          startIcon={<AddIcon />}
        ...
        <Card>
          <CardContent>
            <Typography variant="body2" color="text.secondary" textAlign="center">
              Chưa có dự án nghiên cứu nào được thêm
            </Typography>
          </CardContent>
        </Card>
      )}
